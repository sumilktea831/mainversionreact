...
const CardKagaStar = props => {
    ...
    switch (Math.round(star)) {
        case 0:
            stardom =
                emptystar.repeat(4) + '<i class="cardStar far fa-star mx-1" />'
            break
        case 1:
            stardom =
                fullstar.repeat(1) +
        ...
        case 4:
            stardom =
                fullstar.repeat(4) + '<i class="cardStar far fa-star mx-1" />'
            break
        default:
            stardom =
                fullstar.repeat(4) + '<i class="cardStar fas fa-star mx-1" />'
            break
    }
    return (
        <div
            className="Container"
            dangerouslySetInnerHTML={{ __html: stardom }}
        />
    )
}
